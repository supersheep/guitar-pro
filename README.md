...
```bash
$ cortex install guitar-pro --save
```
...
```js
var guitar_pro = require('guitar-pro');
```
...
Creates a new guitar-pro instance.
...
### guitar-pro.&lt;method-name&gt;(arguments)
